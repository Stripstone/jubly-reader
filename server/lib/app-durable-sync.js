...
function canonicalizeAnnotationPayload(userId, payload = {}) {
  ...
  return {
    ...
    note_text: type === 'note' ? toText(payload.note_text || payload.noteText, null) : toText(payload.note_text || payload.noteText, null),
    flashcard_front: type === 'flashcard' ? toText(payload.flashcard_front || payload.flashcardFront, null) : toText(payload.flashcard_front || payload.flashcardFront, null),
