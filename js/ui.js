      ...
      function setDiagVisible(v) {
        ...
        const merged = {
          usage: {
            ...
            remaining: usageSnapshot && usageSnapshot.remaining != null ? usageSnapshot.remaining : '—',
            allowance: usageSnapshot && usageSnapshot.allowance != null ? usageSnapshot.allowance : '—',
