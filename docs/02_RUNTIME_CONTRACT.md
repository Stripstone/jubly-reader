...
- when a loaded source has another chapter, reading mode shows a **Next Chapter** control after the final card; it advances to the next chapter and is omitted on the final chapter
